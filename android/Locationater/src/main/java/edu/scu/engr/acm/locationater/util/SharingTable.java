 ...
 */
public class SharingTable extends SQLiteOpenHelper {

    public static final String TABLE_NAME = "sharing";
    ...
    public SharingTable (Context context) {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        Log.w(SharingTable.class.getName(),
